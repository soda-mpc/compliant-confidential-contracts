...
contract TransferAllowance64TestsContract is DecryptionCaller {
    ...
    function setDecryptions(gtUint64 newA_s, gtUint64 newB_s, gtBool res_s, gtUint64 newAllowance_s, uint256[] memory arrToDecrypt, uint32 index) internal {
        arrToDecrypt[index] = gtUint64.unwrap(newA_s);
        arrToDecrypt[index+1] = gtUint64.unwrap(newB_s);
        arrToDecrypt[index+2] = gtBool.unwrap(res_s);
        arrToDecrypt[index+3] = gtUint64.unwrap(newAllowance_s);
    }

    function computeAndCheckTransfer64(AllGTCastingValues memory allGTCastingValues, AllAmountValues memory allAmountValues, AllAllowanceValues memory allAllowanceValues, uint256[] memory arrToDecrypt) public {

        uint32 index = 0;

        // Perform all options for casting to 64 while amount is 64 and allowance is 64
        ...
        // Perform all options for casting to 64 while amount is 32 and allowance is 64
        ...
        // Perform all options for casting to 64 while amount is 16 and allowance is 64
        ...
        // Perform all options for casting to 64 while amount is 8 and allowance is 64
        ...
        // Perform all options for casting to 64 while amount is 64 and allowance is 32
        ...
        // Perform all options for casting to 64 while amount is 32 and allowance is 32
        ...
        (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a8_s, allGTCastingValues.b64_s, allAmountValues.amount32_s, allAllowanceValues.allowance32_s);
        setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        index += NUM_DECRYPTIONS_PER_TRANSFER;
        ...
        // Perform all options for casting to 64 while amount is 16 and allowance is 32
        ...
        (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a8_s, allGTCastingValues.b64_s, allAmountValues.amount16_s, allAllowanceValues.allowance32_s);
        setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        index += NUM_DECRYPTIONS_PER_TRANSFER;
        ...
        // Perform all options for casting to 64 while amount is 8 and allowance is 32
        ...
        (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a8_s, allGTCastingValues.b64_s, allAmountValues.amount8_s, allAllowanceValues.allowance32_s);
        setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        index += NUM_DECRYPTIONS_PER_TRANSFER;
        ...
        // Perform all options for casting to 64 while amount is 64 and allowance is 16
        ...
        // Perform all options for casting to 64 while amount is 32 and allowance is 16
        ...
        (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a8_s, allGTCastingValues.b64_s, allAmountValues.amount32_s, allAllowanceValues.allowance16_s);
        setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        index += NUM_DECRYPTIONS_PER_TRANSFER;
        ...
        // Perform all options for casting to 64 while amount is 16 and allowance is 16
        ...
        (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a8_s, allGTCastingValues.b64_s, allAmountValues.amount16_s, allAllowanceValues.allowance16_s);
        setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        index += NUM_DECRYPTIONS_PER_TRANSFER;
        ...
        // // Perform all options for casting to 64 while amount is 32 and allowance is 8
        ...
        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a8_s, allGTCastingValues.b64_s, allAmountValues.amount32_s, allAllowanceValues.allowance8_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;
        ...
        // // Perform all options for casting to 64 while amount is 16 and allowance is 8
        ...
        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a8_s, allGTCastingValues.b64_s, allAmountValues.amount16_s, allAllowanceValues.allowance8_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;
        ...
        // // Perform all options for casting to 64 while amount is 8 and allowance is 8
        ...
        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a8_s, allGTCastingValues.b64_s, allAmountValues.amount8_s, allAllowanceValues.allowance8_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;
