...
contract TransferAllowance128TestsContract is DecryptionCaller {
    ...
    function setDecryptions(gtUint128 newA_s, gtUint128 newB_s, gtBool res_s, gtUint128 newAllowance_s, uint256[] memory arrToDecrypt, uint32 index) internal {
        arrToDecrypt[index] = gtUint128.unwrap(newA_s);
        arrToDecrypt[index+1] = gtUint128.unwrap(newB_s);
        arrToDecrypt[index+2] = gtBool.unwrap(res_s);
        arrToDecrypt[index+3] = gtUint128.unwrap(newAllowance_s);
    }

    function computeAndCheckTransfer128(AllGTCastingValues memory allGTCastingValues, AllAmountValues memory allAmountValues, AllAllowanceValues memory allAllowanceValues, uint256[] memory arrToDecrypt) public {

        uint32 index = 0;
        uint32 NUM_DECRYPTIONS_PER_TRANSFER = 4;
        // Perform all options for casting to 128 while amount is 128 and allowance is 128
        ...
        // Perform all options for casting to 128 while amount is 64 and allowance is 128
        ...
        // Perform all options for casting to 128 while amount is 32 and allowance is 128
        ...
        // Perform all options for casting to 128 while amount is 16 and allowance is 128
        ...
        // Perform all options for casting to 128 while amount is 8 and allowance is 128
        ...
        // Perform all options for casting to 128 while amount is 128 and allowance is 64
        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b128_s, allAmountValues.amount128_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a8_s, allGTCastingValues.b128_s, allAmountValues.amount128_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b8_s, allAmountValues.amount128_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a16_s, allGTCastingValues.b128_s, allAmountValues.amount128_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b16_s, allAmountValues.amount128_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b32_s, allAmountValues.amount128_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a32_s, allGTCastingValues.b128_s, allAmountValues.amount128_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b64_s, allAmountValues.amount128_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a64_s, allGTCastingValues.b128_s, allAmountValues.amount128_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // // Perform all options for casting to 128 while amount is 64 and allowance is 64
        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b128_s, allAmountValues.amount64_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a8_s, allGTCastingValues.b128_s, allAmountValues.amount64_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b8_s, allAmountValues.amount64_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a16_s, allGTCastingValues.b128_s, allAmountValues.amount64_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b16_s, allAmountValues.amount64_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b32_s, allAmountValues.amount64_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a32_s, allGTCastingValues.b128_s, allAmountValues.amount64_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b64_s, allAmountValues.amount64_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a64_s, allGTCastingValues.b128_s, allAmountValues.amount64_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // // Perform all options for casting to 128 while amount is 32 and allowance is 64
        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b128_s, allAmountValues.amount32_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a8_s, allGTCastingValues.b128_s, allAmountValues.amount32_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b8_s, allAmountValues.amount32_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a16_s, allGTCastingValues.b128_s, allAmountValues.amount32_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b16_s, allAmountValues.amount32_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b32_s, allAmountValues.amount32_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a32_s, allGTCastingValues.b128_s, allAmountValues.amount32_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b64_s, allAmountValues.amount32_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a64_s, allGTCastingValues.b128_s, allAmountValues.amount32_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // // Perform all options for casting to 128 while amount is 16 and allowance is 64
        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b128_s, allAmountValues.amount16_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a8_s, allGTCastingValues.b128_s, allAmountValues.amount16_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b8_s, allAmountValues.amount16_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a16_s, allGTCastingValues.b128_s, allAmountValues.amount16_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b16_s, allAmountValues.amount16_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b32_s, allAmountValues.amount16_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a32_s, allGTCastingValues.b128_s, allAmountValues.amount16_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b64_s, allAmountValues.amount16_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a64_s, allGTCastingValues.b128_s, allAmountValues.amount16_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // // Perform all options for casting to 128 while amount is 8 and allowance is 64
        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b128_s, allAmountValues.amount8_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a8_s, allGTCastingValues.b128_s, allAmountValues.amount8_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b8_s, allAmountValues.amount8_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a16_s, allGTCastingValues.b128_s, allAmountValues.amount8_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b16_s, allAmountValues.amount8_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b32_s, allAmountValues.amount8_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a32_s, allGTCastingValues.b128_s, allAmountValues.amount8_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a128_s, allGTCastingValues.b64_s, allAmountValues.amount8_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;

        // (newA_s, newB_s, res_s, newAllowance_s) = MpcCore.transferWithAllowance(allGTCastingValues.a64_s, allGTCastingValues.b128_s, allAmountValues.amount8_s, allAllowanceValues.allowance64_s);
        // setDecryptions(newA_s, newB_s, res_s, newAllowance_s, arrToDecrypt, index);
        // index += NUM_DECRYPTIONS_PER_TRANSFER;
    ...
    function transferWithAllowanceTest(uint8 a, uint8 b, uint8 amount, uint8 allowance) public returns (uint256) {
        ...
        uint256[] memory arrToDecrypt = new uint256[](180);

        // Calculate the result with casting to 128
        computeAndCheckTransfer128(allGTCastingValues, allAmountValues, allAllowanceValues, arrToDecrypt);
