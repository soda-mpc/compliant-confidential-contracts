...
export class SodaWeb3Helper {
    ...
    async setupContract(contractPath, contractName, contractId, overwrite = false, MpcInterfacePath = "lib/onchain/contracts/MpcInterface.sol", mpcCorePath = "lib/onchain/contracts/MpcCore.sol", address_path="lib/onchain/contracts/") {
    ...
    async compileContract(filePath, fileName, MpcInterfacePath = MPC_INTERFACE_PATH, mpcCorePath = MPC_CORE_PATH, address_path=CONTRACTS_ADDRESS_PATH) {
        ...
        const compiledSol = JSON.parse(compiler.compile(JSON.stringify(input)));
