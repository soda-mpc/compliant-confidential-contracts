...
import "./PrivateERC20Contract.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";

/// @title PrivateERC20Factory
/// @notice Factory contract for creating PrivateERC20 tokens with MPC privacy features
/// @dev This factory allows users to deploy new instances of PrivateERC20Contract with custom parameters
contract PrivateERC20Factory {
    ...
    function createToken(
        ...
        // Deploy the new PrivateERC20Contract with msg.sender as owner
        PrivateERC20Contract newToken = new PrivateERC20Contract(name, symbol, underlying, msg.sender);
